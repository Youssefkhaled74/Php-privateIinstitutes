...
$_Select = " SELECT * FROM `the institutes`";
$the_select=mysqli_query($Mysql,$_Select);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>All private istitutes</title>
    <link rel="stylesheet" href="./css/style.css">
    <link rel="stylesheet" href="./The css Bootstrab/bootstrap.css">
</head>
<body>
<h1 class="text-info text-center"> All private institutes</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php foreach ( $the_select as $data){ ?>
                    <tr>
