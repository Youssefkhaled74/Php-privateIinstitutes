...
$_SelectCena = " SELECT * FROM `the institutes` WHERE `governorate`= 'سينا' ";
$the_select_Cena=mysqli_query($Mysql,$_SelectCena);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<h1 class="text-info text-center"> Cina private institutes</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php foreach ( $the_select_Cena as $data){ ?>
                    <tr>
