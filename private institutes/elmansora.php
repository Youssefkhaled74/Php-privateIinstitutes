...
$_Selectmansora = " SELECT * FROM `the institutes` WHERE `governorate`= 'المنصورة' ";
$the_select_mansora=mysqli_query($Mysql,$_Selectmansora);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>El Mansora</title>
    <link rel="stylesheet" href="./css/style.css">
    <link rel="stylesheet" href="./The css Bootstrab/bootstrap.css">
</head>
<body>
<h1 class="text-info text-center">El mansora private institutes</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php foreach ( $the_select_mansora as $data){ ?>
                    <tr>
