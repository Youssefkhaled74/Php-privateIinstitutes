...
$_SelectDomyat = " SELECT * FROM `the institutes` WHERE `governorate`= 'دمياط' ";
$the_select_Domyat=mysqli_query($Mysql,$_SelectDomyat);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
<h1 class="text-info text-center">Domyat private institutes</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php foreach ( $the_select_Domyat as $data){ ?>
                    <tr>
